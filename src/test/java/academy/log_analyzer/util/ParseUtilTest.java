...
public class ParseUtilTest {
    ...
    void parseNginxLogString() {
        String logString =
                "54.77.119.190 - - [23/May/2015:22:05:13 +0000] \"GET /downloads/product_2 HTTP/1.1\" 404 336 \"-\" \"Debian APT-HTTP/1.3 (1.0.1ubuntu2)\"";
        LogEntry logEntry = new LogEntry(
                "54.77.119.190",
                "-",
                OffsetDateTime.of(LocalDateTime.parse("2015-05-23T22:05:13"), ZoneOffset.ofHours(0)),
                "GET",
                "/downloads/product_2",
                "HTTP/1.1",
                404,
