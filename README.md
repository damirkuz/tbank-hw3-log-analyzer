...
- `--output, -o` - путь до файла, куда должен быть сохранён результат работы программы
    - программа должна завершить свою работу с ошибкой, если:
        ...
        - расширение файла не соответствует ожидаемому
...
по какой-то причине строка не соответствует данному формату, данная непредвиденная ситуация должна быть залогирована с
...
- распределение запросов по датам в процентном соотношении от общего числа **(+доп. баллы)**
...
- По возможности необходимо использовать готовые библиотеки для решения поставленных задач.
...
- Сбор статистики распределения запросов по дате - **10 б**.
